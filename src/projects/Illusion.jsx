...
export default function Illusion() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto text-sm sm:p-4">
      ...
      <div className="max-w-[800px] text-center mx-auto my-8 p-4 sm:px-0">
      ...
      <div className="max-w-[800px] text-center mx-auto sm:px-0">
        <p className="text-sm md:text-lg font-semibold">
          Below shows the inside pages from issue 1.
        </p>
      </div>
      <div className="bg-gray-800 h-[400px] mt-4 flex items-center justify-center text-white">
        WHAT ARE THESE SLIDE THINGS
      </div>
      <div className="flex flex-wrap gap-[2%] py-4">
      ...
      <div className="bg-gray-800 h-[400px] group mt-4 flex items-center justify-center text-white">
        Video Here
        <br />
